...
Команды:
  Напиши «пары сегодня», «пары завтра», «пары 15 мая»
  Напиши «когда кримка», «следующая упп» и т.д.
  Напиши «обновить расписание» (принудительный перепарсинг)
"""
...
try:
    print("[3/8] Импортирую random...")
    import random
    print("✅ random OK")
except Exception as e:
    print(f"❌ random FAIL: {e}")
    sys.exit(1)

try:
    print("[4/8] Импортирую re...")
    import re
    print("✅ re OK")
except Exception as e:
    print(f"❌ re FAIL: {e}")
...
print("=" * 60)
print("✅ ВСЕ ИМПОРТЫ OK! Запускаю бота...")
print("=" * 60)
print()
...
ROAST_REPLIES = [
    ...
    "💀 Даже расписание от тебя отвернулось.",
    "🐒 К сожалению, расписание доступно только для людей.",
    "📉 Твоя успеваемость настолько низкая, что бот отказывается с тобой разговаривать.",
    "🪳 О, привет, таракан. Расписание для насекомых не предусмотрено.",
    "🤮 Каждый раз, когда ты мне пишешь, я теряю байты оперативки от отвращения.",
]
